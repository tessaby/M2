 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Tessneem Belhadj");
		  toPrint += p1.toString("tby3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Joseph McCall");
		  toPrint += p2.toString("jmccall9");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("AliBharwani");
		  toPrint += p3.toString("abharwani3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Sangwon Yuh");
                  toPrint += p4.toString("syuh3");
